(function(a){var k;try{k="string"==typeof a("body").css("background-position-x")}catch(l){k=!1}a._spritely={animate:function(b){var d=a(b.el),c=d.attr("id");if(!a._spritely.instances[c])return this;b=a.extend(b,a._spritely.instances[c]||{});if("sprite"==b.type&&b.fps){b.play_frames&&!a._spritely.instances[c].remaining_frames?a._spritely.instances[c].remaining_frames=b.play_frames+1:b.do_once&&!a._spritely.instances[c].remaining_frames&&(a._spritely.instances[c].remaining_frames=b.no_of_frames);var f,
e=function(d){var e=b.width;if(!f){f=[];for(var g=total=0;g<b.no_of_frames;g++)f[f.length]=0-total,total+=e}if(0==a._spritely.instances[c].current_frame){if(b.on_first_frame)b.on_first_frame(d)}else if(a._spritely.instances[c].current_frame==f.length-1&&b.on_last_frame)b.on_last_frame(d);if(b.on_frame&&b.on_frame[a._spritely.instances[c].current_frame])b.on_frame[a._spritely.instances[c].current_frame](d);a._spritely.instances[c].current_frame=!0==b.rewind?0>=a._spritely.instances[c].current_frame?
f.length-1:a._spritely.instances[c].current_frame-1:a._spritely.instances[c].current_frame>=f.length-1?0:a._spritely.instances[c].current_frame+1;e=a._spritely.getBgY(d);d.css("background-position",f[a._spritely.instances[c].current_frame]+"px "+e);if(b.bounce&&0<b.bounce[0]&&0<b.bounce[1]){var e=b.bounce[0],g=b.bounce[1],h=b.bounce[2];d.animate({top:"+="+e+"px",left:"-="+g+"px"},h).animate({top:"-="+e+"px",left:"+="+g+"px"},h)}};if(a._spritely.instances[c].remaining_frames&&0<a._spritely.instances[c].remaining_frames){a._spritely.instances[c].remaining_frames--;
if(0==a._spritely.instances[c].remaining_frames)return a._spritely.instances[c].remaining_frames=-1,delete a._spritely.instances[c].remaining_frames,this;e(d)}else-1!=a._spritely.instances[c].remaining_frames&&e(d)}else if("pan"==b.type&&!a._spritely.instances[c]._stopped){var e=b.speed||1,g=a._spritely.instances[c].l||parseInt(a._spritely.getBgX(d).replace("px",""),10)||0,h=a._spritely.instances[c].t||parseInt(a._spritely.getBgY(d).replace("px",""),10)||0;if(b.do_once&&!a._spritely.instances[c].remaining_frames||
0>=a._spritely.instances[c].remaining_frames){switch(b.dir){case "up":case "down":a._spritely.instances[c].remaining_frames=Math.floor((b.img_height||0)/e);break;case "left":case "right":a._spritely.instances[c].remaining_frames=Math.floor((b.img_width||0)/e)}a._spritely.instances[c].remaining_frames++}else b.do_once&&a._spritely.instances[c].remaining_frames--;switch(b.dir){case "up":e*=-1;case "down":a._spritely.instances[c].l||(a._spritely.instances[c].l=g);a._spritely.instances[c].t=h+e;b.img_height&&
(a._spritely.instances[c].t%=b.img_height);break;case "left":e*=-1;case "right":a._spritely.instances[c].t||(a._spritely.instances[c].t=h),a._spritely.instances[c].l=g+e,b.img_width&&(a._spritely.instances[c].l%=b.img_width)}e=a._spritely.instances[c].l.toString();e=-1==e.indexOf("%")?e+"px ":e+" ";g=a._spritely.instances[c].t.toString();g=-1==g.indexOf("%")?g+"px ":g+" ";a(d).css("background-position",e+g);if(b.do_once&&!a._spritely.instances[c].remaining_frames)return this}a._spritely.instances[c].options=
...
activeOnClick:function(){var b=a(this);window.Touch?b[0].ontouchstart=function(d){a._spritely.activeSprite=b}:b.click(function(d){a._spritely.activeSprite=b});return this},spRandom:function(b){b=a.extend({top:50,left:50,right:290,bottom:320,speed:4E3,pause:0},b||{});var d=a(this).attr("id");if(!a._spritely.instances[d])return this;if(!a._spritely.instances[d].stop_random){var c=a._spritely.randomIntBetween,f=c(b.top,b.bottom),c=c(b.left,b.right);a("#"+d).animate({top:f+"px",left:c+"px"},b.speed)}window.setTimeout(function(){a("#"+
